...
class fieldtype_users
{
  ...
  static function get_choices($field, $params, $value='')
  {
  	...
  	$choices = array();
  	$order_by_sql = filter_var(($cfg->get('hide_access_group')!=1 ? 'group_name,':''),FILTER_SANITIZE_STRING);
  	$order_by_sql .= filter_var((CFG_APP_DISPLAY_USER_NAME_ORDER=='firstname_lastname' ? ' u.field_7, u.field_8' : ' u.field_8, u.field_7'),FILTER_SANITIZE_STRING);
