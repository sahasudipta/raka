...
class fieldtype_image_map
{
  ...
  function get_configuration()
  {
    ...
    $choices = array();       
    $fields_query = db_query("select * from app_fields where type not in (" . implode(",",filter_var_array($exclude_types)) . ") and entities_id='" . db_input(filter_var($_POST['entities_id'],FILTER_SANITIZE_STRING)) . "'");
    ...
    $choices = array();
    $choices[''] = '';
    $fields_query = db_query("select * from app_fields where type in ('fieldtype_dropdown','fieldtype_radioboxes') and entities_id='" . db_input(filter_var($_POST['entities_id'],FILTER_SANITIZE_STRING)) . "'");
    while($fields = db_fetch_array($fields_query))
    {
  ...
  {  	  	
  	...
  	{  		
  		...
  		{  	
  			//update db
  			db_query("update app_fields_choices set filename = '" . db_input($filename) . "' where id = '" . db_input(filter_var($choices_id,FILTER_SANITIZE_STRING)). "'");
