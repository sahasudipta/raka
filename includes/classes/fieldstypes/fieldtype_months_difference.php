...
END;";
	...
	public static function prepare_query($fields,$prefix = 'e', $single_select = false, $force_query = false)
	{
		...
		{
			$mysql_query =  "rukovoditel_months_diff(" . $start_date_field . "," . $end_date_field . "," . $cfg->get('calclulate_diff_days',0). ") as field_" . filter_var($fields['id'],FILTER_SANITIZE_STRING);
		}
