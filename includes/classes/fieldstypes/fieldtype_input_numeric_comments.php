...
class fieldtype_input_numeric_comments
{
  ...
  function get_fields_sum($entity_id,$item_id,$field_id)
  {
    ...
    {
      $history_query = db_query("select * from app_comments_history where comments_id='" . db_input(filter_var($comments['id'],FILTER_SANITIZE_STRING)) . "' and fields_id='" . db_input(filter_var($field_id,FILTER_SANITIZE_STRING)). "'");
