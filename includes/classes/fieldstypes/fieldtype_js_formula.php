...
class fieldtype_js_formula
{
  ...
  function get_configuration()
  {
    ...
    $cfg[] = array('title'=>TEXT_FORMULA . fields::get_available_fields_helper(filter_var($_POST['entities_id'],FILTER_SANITIZE_STRING), 'fields_configuration_formula'), 'name'=>'formula','type'=>'textarea','tooltip'=>TEXT_JS_FORMULA_TIP,'params'=>array('class'=>'form-control code'));
