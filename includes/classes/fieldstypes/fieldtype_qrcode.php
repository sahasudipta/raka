...
class fieldtype_qrcode
{
	...
	function get_configuration()
	{
		...
		$cfg[] = array('title'=>TEXT_QRCODE_PATTERN  . fields::get_available_fields_helper(filter_var($_POST['entities_id'],FILTER_SANITIZE_STRING), 'fields_configuration_pattern'), 
                   'name'=>'pattern',
                   'type'=>'textarea',    
