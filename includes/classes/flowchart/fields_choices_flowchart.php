...
class fields_choices_flowchart
{
	...
	{				
		...
		foreach($tree as $v)
		{
			...
			$reports_info_query = db_query("select * from app_reports where entities_id='" . db_input(filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING)). "' and reports_type='".filter_var($reports_type,FILTER_SANITIZE_STRING)."'");
