...
class forms_tabs
{
  ...
  {
    $choices = array();
    $query = db_fetch_all('app_forms_tabs',"entities_id='" . db_input((int)$entities_id) . "'",'sort_order, name');   
  ...
  {
    $tab_query = db_query("select * from app_fields where forms_tabs_id='" . db_input(filter_var($tabs_id ,FILTER_SANITIZE_STRING)). "' and type='fieldtype_id'");
