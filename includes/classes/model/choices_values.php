...
class choices_values
{
  ...
  {  
    //reset choices values for current item and field
    db_query("delete from app_entity_" . filter_var($this->entities_id,FILTER_SANITIZE_STRING) . "_values where items_id='" . db_input($items_id) . "' and fields_id='" . filter_var($fields_id,FILTER_SANITIZE_STRING). "'");    
  ...
  {
    db_query("delete from app_entity_" . $entities_id . "_values where fields_id='" . db_input(filter_var($fields_id,FILTER_SANITIZE_STRING)) . "'");      
  }
}