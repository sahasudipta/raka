...
//set module action
  $app_module_action = (isset($_GET['action']) ? filter_var($_GET['action'],FILTER_SANITIZE_STRING) : (isset($_POST['action']) ? filter_var($_POST['action'],FILTER_SANITIZE_STRING) : ''));
  
//set module redirect  
  //$app_redirect_to = (isset(filter_var($_GET['redirect_to'],FILTER_SANITIZE_STRING)) ? filter_var($_GET['redirect_to'] ,FILTER_SANITIZE_STRING): (isset(filter_var($_POST['redirect_to'],FILTER_SANITIZE_STRING)) ? filter_var($_POST['redirect_to'],FILTER_SANITIZE_STRING) : '')); 
 
  $app_redirect_to = (isset($_GET['redirect_to']) ? filter_var($_GET['redirect_to'],FILTER_SANITIZE_STRING): (isset($_POST['redirect_to']) ? filter_var($_POST['redirect_to'],FILTER_SANITIZE_STRING) : '')); 
 // $app_redirect_to = (isset($_GET['redirect_to']) ? filter_var($_GET['redirect_to'] ,FILTER_SANITIZE_STRING): (isset($_POST['redirect_to']) ? filter_var($_POST['redirect_to'],FILTER_SANITIZE_STRING) : ''));    
  
//set app apth  
  $app_path = (isset($_GET['path']) ? filter_var($_GET['path'],FILTER_SANITIZE_STRING) : (isset($_POST['path']) ? filter_var($_POST['path'],FILTER_SANITIZE_STRING) : ''));
