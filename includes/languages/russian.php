...
define('TEXT_MENU_ICON_TITLE_TOOLTIP','Введите название иконки из библиотеки <a href="https://fontawesome.com/v4.7.0/icons/" target="_blank">Font Awesome</a> или <a href="https://icons8.com/line-awesome" target="_blank">Line Awesome</a><br>Например: fa-bell или la-bell.');
...
define('TEXT_CHOICES_VALUE_INFO','Значение может использоваться в вычислениях формулы. <a href="https://docs.rukovoditel.net.ru/index.php?p=25" target="_blank">Подробнее</a>');
...
define('TEXT_JS_FORMULA_TIP','Используйте [ID поля] для установки значения поля в формуле. Пример: ([36]+[54])/2 где 36 и 54 - идентификаторы числовых полей. <a href="https://docs.rukovoditel.net.ru/index.php?p=25" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_GLOBAL_LIST_USER_NOTES','Данная опция используется, если список применяется к полю "Группа пользователй".');
...
define('TEXT_FIELDTYPE_SIGNATURE_TOOLTIP','Поле позволяет добавить имя и подпись. Не связано с пользователями приложения.');
