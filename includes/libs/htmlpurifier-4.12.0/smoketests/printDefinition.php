...
<?php
    echo htmlentities($printer_config_form->render($config, 'HTML'));
?>
...
<?php echo htmlentities($printer_html_definition->render($config)) ?>
<h2>CSSDefinition</h2>
<?php echo htmlentities($printer_css_definition->render($config)) ?>
</body>
</html>
<?php
