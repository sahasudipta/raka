    ...
    case 'fieldtype_user_roles':    
        ...
        <!--list-->
          ...
          <div class="form-group settings-list settings-table">
            ...
            <div class="col-md-4">' . input_tag('settings[font_name]',$settings->get('font_name','Times New Roman'),['class'=>'form-control input-medium required']) . tooltip_text(TEXT_EXAMPLE . ': Times New Roman, Areal') . '</div>
