...
<?php echo form_tag('choices_form', url_for('ext/filters_panels/fields','action=sort&redirect_to=' . $app_redirect_to . '&entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING) . '&panels_id=' . filter_var($_GET['panels_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
