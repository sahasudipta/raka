...
<?php $obj = db_find('app_ext_xml_export_templates',filter_ver($_GET['id'],FILTER_SANITIZE_STRING)); ?>

<?php echo form_tag('login', url_for('ext/xml_export/templates','action=delete&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING) )) ?>
