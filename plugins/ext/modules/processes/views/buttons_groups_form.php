...
<?php echo form_tag('process_form', url_for('ext/processes/buttons_groups','action=save' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
