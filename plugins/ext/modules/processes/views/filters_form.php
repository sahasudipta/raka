...
<?php echo form_tag('reports_filters', url_for('ext/processes/filters','action=save' .  (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):''). '&process_id=' . filter_var($_GET['process_id'],FILTER_SANITIZE_STRING) ),array('class'=>'form-horizontal')) ?>
