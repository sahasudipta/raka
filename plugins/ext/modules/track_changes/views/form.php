...
<?php echo form_tag('track_changes_form', url_for('ext/track_changes/reports','action=save' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
