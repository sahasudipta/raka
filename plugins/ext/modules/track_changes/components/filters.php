...
{
	//check access
	if(!users::has_users_access_name_to_entity('view',filter_var($entities['id'],FILTER_SANITIZE_STRING))) continue;
	
	$choices[filter_var($entities['id'],FILTER_SANITIZE_STRING)] = filter_var($entities['entity_name'],FILTER_SANITIZE_STRING);
}
