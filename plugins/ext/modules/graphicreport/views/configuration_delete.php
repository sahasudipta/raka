...
<?php $obj = db_find('app_ext_graphicreport',filter_var($_GET['id'],FILTER_SANITIZE_STRING)); ?>

<?php echo form_tag('login', url_for('ext/graphicreport/configuration','action=delete&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING) )) ?>
