...
<?php echo form_tag('reports_form', url_for('ext/reports_groups/reports','action=save' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
