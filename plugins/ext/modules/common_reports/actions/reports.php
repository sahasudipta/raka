...
switch($app_module_action)
{
  ...
  case 'save':
    $sql_data = array('name'=>filter_var($_POST['name'],FILTER_SANITIZE_STRING),
                      ...
                      'in_dashboard_icon'=>(isset($_POST['in_dashboard_icon']) ? filter_var($_POST['in_dashboard_icon'],FILTER_SANITIZE_STRING):0),
                      ...
                      'in_header_autoupdate'=>(isset($_POST['in_header_autoupdate']) ?filter_var($_POST['in_header_autoupdate']):0),
                      'displays_assigned_only'=>(isset($_POST['displays_assigned_only']) ? filter_var($_POST['displays_assigned_only']):0),                      
                      ...
                      'rows_per_page' => (isset($_POST['rows_per_page']) ? filter_var($_POST['rows_per_page'],FILTER_SANITIZE_STRING):''),                      
                      );
