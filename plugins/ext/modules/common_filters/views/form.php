...
<?php echo form_tag('common_filters_form', url_for('ext/common_filters/reports','action=save' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
