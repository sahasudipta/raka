...
$current_templates_info_query = db_query("select * from app_ext_export_templates where id='" . db_input(filter_var($_GET['templates_id'],FILTER_SANITIZE_STRING)). "'");
...
switch($app_module_action)
{
  case 'save':
    ...
    redirect_to('ext/templates/export_templates_filters','templates_id=' . filter_var($_GET['templates_id'],FILTER_SANITIZE_STRING));
