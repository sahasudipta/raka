...
switch($app_module_action)
{
  ...
  case 'save':
    $sql_data = array('name'=>filter_var($_POST['name'],FILTER_SANITIZE_STRING),
                      ...
                      'multilevel_import'=>filter_var($_POST['multilevel_import'],FILTER_SANITIZE_STRING),                      
                      ...
                      'import_fields' => (isset($_POST['import_fields']) ? json_encode(filter_var_array($_POST['import_fields'])):''),                      
                      );
        
    if(isset($_GET['id']))
    {                             
      db_perform('app_ext_import_templates',$sql_data,'update',"id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");       
    }
    else
    {                     
  ...
  case 'delete':
      if(isset($_GET['id']))
      {                    
        db_query("delete from app_ext_import_templates where id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");        
  ...
  case 'get_subentities':
  	if(isset($_POST['id']))
  	{
  		$obj = db_find('app_ext_import_templates',filter_var($_POST['id'],FILTER_SANITIZE_STRING));
  	}
  	else
  	{
