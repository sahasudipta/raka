...
switch($app_module_action)
{
  ...
  case 'save':
    ...
    { 
      ...
      $template_info = db_find('app_ext_comments_templates',filter_var($_GET['id'],FILTER_SANITIZE_STRING));
      if($template_info['entities_id']!=$_POST['entities_id'])
      {
        db_query("delete from app_ext_comments_templates_fields where templates_id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");
      }
                           
      db_perform('app_ext_comments_templates',$sql_data,'update',"id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");       
    }
    else
    {                     
  ...
  case 'delete':
      ...
      {      
        ...
        db_query("delete from app_ext_comments_templates where id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");
        db_query("delete from app_ext_comments_templates_fields where templates_id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");
