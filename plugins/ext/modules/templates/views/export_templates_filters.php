...
<div class="panel panel-default">
  <div class="panel-heading"><?php echo TEXT_FILTERS_FOR_ENTITY . ': <b>' . htmlentities($entity_info['name']) . '</b>' ?></div>
    ...
    ?>
      <tr>
        <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/templates/export_templates_filters_delete','templates_id=' . $current_templates_info['id'] . '&id=' . filter_var($v['id'],FILTER_SANITIZE_STRING) . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param)) . ' ' . button_icon_edit(url_for('ext/templates/export_templates_filters_form','templates_id=' . $current_templates_info['id'] . '&id=' . filter_var($v['id'],FILTER_SANITIZE_STRING) . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param))  ?></td>    
