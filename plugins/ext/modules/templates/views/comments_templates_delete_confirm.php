...
<?php $obj = db_find('app_ext_comments_templates',filter_var($_GET['id'],FILTER_SANITIZE_STRING)); ?>

<?php echo form_tag('login', url_for('ext/templates/comments_templates','action=delete&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING) )) ?>
