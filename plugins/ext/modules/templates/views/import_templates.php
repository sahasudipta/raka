...
?>
<tr>
  <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/templates/import_templates_delete','id=' . filter_var($templates['id'],FILTER_SANITIZE_STRING))) . ' ' . button_icon_edit(url_for('ext/templates/import_templates_form','id=' . filter_var($templates['id'],FILTER_SANITIZE_STRING))) ?></td>
