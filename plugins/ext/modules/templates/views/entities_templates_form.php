...
<?php echo form_tag('entities_templates_form', url_for('ext/templates/entities_templates','action=save' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
