...
<?php echo form_tag('comments_templates_form', url_for('ext/templates/comments_templates','action=save' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
...
<div class="tab-content">
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">	
  	  <div class="checkbox-list"><label class="checkbox-inline"><?php echo select_checkboxes_tag('users_groups',access_groups::get_choices(),$obj['users_groups']) ?></label></div>      
    </div>			
  </div> 
