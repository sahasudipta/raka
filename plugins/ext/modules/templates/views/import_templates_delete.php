...
<?php $obj = db_find('app_ext_import_templates',filter_var($_GET['id'],FILTER_SANITIZE_STRING)); ?>

<?php echo form_tag('login', url_for('ext/templates/import_templates','action=delete&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING) )) ?>
