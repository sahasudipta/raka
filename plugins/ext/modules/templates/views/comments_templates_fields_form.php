...
<?php echo form_tag('comments_templates_fields', url_for('ext/templates/comments_templates_fields','action=save&templates_id=' . $template_info['id'] .  (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
