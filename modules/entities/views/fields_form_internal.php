...
<?php echo form_tag('fields_form', url_for('entities/fields','action=save_internal' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
