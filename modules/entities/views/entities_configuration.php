...
<?php echo form_tag('cfg', url_for('entities/entities_configuration','action=save&entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
