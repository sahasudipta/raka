...
<h3 class="page-title"><?php echo TEXT_FIELD_SETTINGS . ': ' . htmlentities($fields_info['name']) ?></h3>

<?php echo form_tag('fields_form', url_for('entities/fields_settings','action=save&fields_id=' . filter_var($_GET['fields_id'],FILTER_SANITIZE_STRING) . '&entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING))) ?>
