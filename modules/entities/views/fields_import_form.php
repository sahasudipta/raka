...
<?php echo form_tag('import_form', url_for('entities/fields','action=import&entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal','enctype'=>'multipart/form-data')) ?>
