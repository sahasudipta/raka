...
<?php echo form_tag('login', url_for('entities/fields','action=delete&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING) . '&entities_id=' .filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING))) ?>
