...
<?php echo form_tag('form-copy-to', url_for('entities/fields','action=copy_selected&entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
