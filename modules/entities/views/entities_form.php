...
<?php echo form_tag('entities_form', url_for('entities/','action=save' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
<div class="modal-body">
  <div class="form-body">
  
<?php if(isset($_GET['parent_id'])) echo input_hidden_tag('parent_id',filter_var($_GET['parent_id'],FILTER_SANITIZE_STRING)) ?>
