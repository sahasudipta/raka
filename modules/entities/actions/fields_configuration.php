...
if(isset($_POST['field_type']))
{
  ...
  {  
    echo fields_types::render_configuration($field_type->get_configuration(array('entities_id'=>filter_var($_POST['entities_id'],FILTER_SANITIZE_STRING))),filter_var($_POST['id'],FILTER_SANITIZE_STRING));
  }
}
