...
switch($app_module_action)
{
    case 'save':
        ...
        $sql_data = array(
            ...
            'fields_id'=>_filter_var(POST('fields_id'),FILTER_SANITIZE_STRING),
            'fields_values' => (is_array($_POST['fields_values']) ? implode(',',filter_var_array($_POST['fields_values'])) : filter_var($_POST['fields_values'],FILTER_SANITIZE_STRING)),
        ...
        if(isset($_GET['id']))
        {
            db_perform('app_listing_highlight_rules',$sql_data,'update',"id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");
        }
        else
        {
