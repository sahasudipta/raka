...
$reports_type = 'fieldfilter' . filter_var($_GET['fields_id'],FILTER_SANITIZE_STRING); 
...
if(!$reports_info = db_fetch_array($reports_info_query))
{
  ...
  redirect_to('entities/fields_filters','entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING). '&fields_id=' . filter_var($_GET['fields_id'],FILTER_SANITIZE_STRING));
}  
...
switch($app_module_action)
{
  case 'save':
    ...
    redirect_to('entities/fields_filters','reports_id=' . filter_var($_GET['reports_id'],FILTER_SANITIZE_STRING) . '&entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING). '&fields_id=' . filter_var($_GET['fields_id'],FILTER_SANITIZE_STRING));      
  break;
  case 'delete':
      if(isset($_GET['id']))
      {      
