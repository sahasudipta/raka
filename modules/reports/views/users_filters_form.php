...
<?php echo form_tag('users_filters', url_for('reports/users_filters','action=save&reports_id=' . filter_var($_GET['reports_id'],FILTER_SANITIZE_STRING) ),array('class'=>'form-horizontal')) ?>
