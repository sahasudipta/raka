...
?>
  <tr>
    <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('reports/delete','id=' . filter_var($v['id'],FILTER_SANITIZE_STRING))) . ' ' . button_icon_edit(url_for('reports/form','id=' . filter_var($v['id'],FILTER_SANITIZE_STRING))) . ' ' . button_icon(TEXT_BUTTON_CONFIGURE_FILTERS,'fa fa-cogs',url_for('reports/filters','reports_id=' . filter_var($v['id'],FILTER_SANITIZE_STRING)),false); ?></td>    
    <td><?php echo htmlentities($v['id']) ?></td>
    <td><?php echo htmlentities($v['entities_name']) ?></td>
    <td><?php echo link_to(filter_var($v['name'],FILTER_SANITIZE_STRING),url_for('reports/view','reports_id=' . filter_var($v['id'],FILTER_SANITIZE_STRING))) ?></td>
