...
{	
  $page_title = (strlen($entity_cfg->get('listing_heading'))>0 ? $entity_cfg->get('listing_heading') : $entity_info['name']);
  
  if(!filters_panels::has_any($reports_info['entities_id'], $entity_cfg))
  {  	
