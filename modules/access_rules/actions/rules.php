...
switch($app_module_action)
{
	case 'save':
		...
		if(isset($_GET['id']))
		{
			db_perform('app_access_rules',$sql_data,'update',"id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");
		}
		else
		{
	...
	case 'delete':
		...
		if(isset($_GET['id']))
		{
			db_delete_row('app_access_rules',filter_var($_GET['id'],FILTER_SANITIZE_STRING));					
		}
