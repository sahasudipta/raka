...
$fields_query = db_query("select f.*, t.name as tab_name from app_fields f, app_forms_tabs t where f.type not in (" . fields_types::get_reserverd_types_list() . ") and f.entities_id='" . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING) . "' and f.forms_tabs_id=t.id order by t.sort_order, t.name, f.sort_order, f.name");
