...
<?php echo form_tag('menu_form', url_for('filters_panels/panels','action=set_default_panel_access&entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
<div class="modal-body">
  <div class="form-body">

	<p><?php echo TEXT_FILTERS_PANELS_ACCESS_INFO ?></p>
...
?>  
  <div class="form-group">  	
    <div class="col-md-12">	
  	  <?php echo select_tag('users_groups[]',$choices,$entities_cfg->get('default_filter_panel_access'),array('class'=>'form-control chosen-select','multiple'=>'multiple')) ?>
    </div>			
  </div>
