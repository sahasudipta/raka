...
<?php echo form_tag('menu_form', url_for('filters_panels/panels','action=set_listing_config_access&entities_id=' . filter_var($_GET['entities_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
