...
switch(true)
{
	...
	case strstr($section_report,'graphicreport'):
		...
		if($reports = db_fetch_array($reports_query))
		{
			...
			{
				echo '<h3 class="page-title"><a href="' . url_for('ext/graphicreport/view','id=' . filter_var($reports['id'],FILTER_SANITIZE_STRING)) . '">' . filter_var($reports['name'],FILTER_SANITIZE_STRING) . '</a></h3>';
	...
	case strstr($section_report,'funnelchart'):
		...
		while($reports = db_fetch_array($reports_query))
		{
			...
			{
				echo '<h3 class="page-title"><a href="' . url_for('ext/funnelchart/view','id=' . filter_var($reports['id'],FILTER_SANITIZE_STRING)) . '">' . filter_var($reports['name'],FILTER_SANITIZE_STRING) . '</a></h3>';
	...
	case strstr($section_report,'pivotreports'):
		...
		{			
			...
			{
				echo '<h3 class="page-title"><a href="' . url_for('ext/pivotreports/view','id=' . filter_var($pivotreports['id'],FILTER_SANITIZE_STRING)) . '">' . filter_var($pivotreports['name'],FILTER_SANITIZE_STRING) . '</a></h3>';
				echo '
						<style>
							.pvtVals{
								display:none;
	...
	case strstr($section_report,'calendarreport'):
		...
		if($reports = db_fetch_array($reports_query))
		{
			echo '<h3 class="page-title"><a href="' . url_for('ext/calendar/report','id=' . filter_var($reports['id'],FILTER_SANITIZE_STRING)) . '">' . filter_var($reports['name'],FILTER_SANITIZE_STRING) . '</a></h3>';
	...
	case strstr($section_report,'pivot_calendars'):
		...
		if($reports = db_fetch_array($reports_query))
		{
			...
			{
				echo '<h3 class="page-title"><a href="' . url_for('ext/pivot_calendars/view','id=' . filter_var($reports['id'],FILTER_SANITIZE_STRING)) . '">' . filter_var($reports['name'],FILTER_SANITIZE_STRING) . '</a></h3>';
