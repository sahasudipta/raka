...
<div class="panel panel-default">
  <div class="panel-heading"><?php echo TEXT_FILTERS_FOR_ENTITY . ': <b>' . filter_var($entity_info['name'],FILTER_SANITIZE_STRING) . '</b>' ?></div>
    ...
    ?>
      <tr>
        <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('records_visibility/filters_delete','rules_id=' . filter_var($current_rules_info['id'],FILTER_SANITIZE_STRING) . '&id=' . filter_var($v['id'],FILTER_SANITIZE_STRING) . '&reports_id=' . filter_var($current_reports_info['id'],FILTER_SANITIZE_STRING) . $parent_reports_param)) . ' ' . button_icon_edit(url_for('records_visibility/filters_form','rules_id=' . filter_var($current_rules_info['id'],FILTER_SANITIZE_STRING) . '&id=' . filter_var($v['id'],FILTER_SANITIZE_STRING) . '&reports_id=' . filter_var($current_reports_info['id'],FILTER_SANITIZE_STRING) . $parent_reports_param))  ?></td>    
