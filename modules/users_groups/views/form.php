...
<?php echo form_tag('users_groups_form', url_for('users_groups/users_groups','action=save' . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
