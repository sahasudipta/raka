...
{	
	switch($fields['type'])
	{
		...
		case 'fieldtype_entity':
			...
			echo fields_types::render(filter_var($fields['type'],FILTER_SANITIZE_STRING),$fields,$obj,array('parent_entity_item_id'=>filter_var($parent_entity_item_id,FILTER_SANITIZE_STRING), 'form'=>'item'));
