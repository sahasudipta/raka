...
switch($app_module_action)
{
  ...
  case 'save':
      ...
      $sql_data = array('description'=>db_prepare_html_input(filter_var($description,FILTER_SANITIZE_STRING)),
                        ...
                        'attachments'=>fields_types::process(array('class'=>'fieldtype_attachments','value'=>filter_var($attachments,FILTER_SANITIZE_STRING))),      
                        );
      
      if(isset($_GET['id']))
      {        
        db_perform('app_comments',$sql_data,'update',"id='" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");            
      }
      else
      {    
  ...
  case 'delete':
      ...
      if(isset($_GET['id']))
      {     
        attachments::delete_comments_attachments(filter_var($_GET['id'],FILTER_SANITIZE_STRING));
                       
        db_delete_row('app_comments',filter_var($_GET['id'],FILTER_SANITIZE_STRING));
        
        db_query("delete from app_comments_history where comments_id = '" . db_input(filter_var($_GET['id'],FILTER_SANITIZE_STRING)) . "'");
