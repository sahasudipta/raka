...
$field_query = db_query("select * from app_fields where id='" . _get::int('field_id') . "' and type='fieldtype_related_records'");
...
switch($app_module_action)
{
	case 'select_items':
		...
		{	
			...
			{					
				$listing_sql_select = fieldtype_formula::prepare_query_select(filter_var($cfg->get('entity_id'),FILTER_SANITIZE_STRING), '',false,array('fields_in_listing'=>implode(',',filter_var_array($matches[1]))));
			}
		}
