  ...
  case 'select_all':
      ...
      if(isset($_POST['checked']))
      {
        ...
        if((isset($_POST['search_keywords']) and strlen($_POST['search_keywords'])>0 and $_POST['search_in_all']=='true') or strlen($_POST['force_display_id']))
				...
				{        
	        $listing_sql_query = reports::add_filters_query(filter_var($_POST['reports_id'],FILTER_SANITIZE_STRING),$listing_sql_query);
        ...
        $listing_sql_query = items::add_access_query(filter_var($current_entity_id,FILTER_SANITIZE_STRING),$listing_sql_query,$force_access_query);
        ...
        $listing_sql_query .= $listing_sql_query_having;
	      ...
	      if(strlen($_POST['listing_order_fields'])>0)
				{  
				  $info = reports::add_order_query(filter_var($_POST['listing_order_fields'],FILTER_SANITIZE_STRING),$current_entity_id);
        ...
        $listing_sql = "select e.* " . $listing_sql_query_select . " from app_entity_" . filter_var($current_entity_id,FILTER_SANITIZE_STRING) . " e "  . $listing_sql_query_join . " where e.id>0 " . $listing_sql_query;        
