...
//start form validation                    
    ...
    //rules for ckeditor
      rules:{
        <?php echo fields::render_required_ckeditor_ruels(filter_var($current_entity_id,FILTER_SANITIZE_STRING)); ?>                       
      },
      
    //custom error messages
      messages: {			    
        <?php echo fields::render_required_messages(filter_var($current_entity_id,FILTER_SANITIZE_STRING)); ?>			   
			},
      ...
      {    
        ...
        //handle users validation
          ...
          { 
            echo 'validate_user_form(form,\'' . url_for('users/validate_form',(isset($_GET['id']) ? 'id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ). '\');'; 
          }
...
<?php
	...
	{
		$url = url_for("items/items","action=check_unique&path=" . filter_var($_GET["path"],FILTER_SANITIZE_STRING) . (isset($_GET["id"]) ? "&id=" . filter_var($_GET["id"],FILTER_SANITIZE_STRING):"") );
	}
?>
