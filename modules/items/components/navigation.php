...
<?php endif ?>  
  ...
  <?php 
  	if($current_item_id==0)
  	{
  		...
  		if(is_ext_installed())
  		{  			
  			$common_filters = new common_filters(filter_var($current_entity_id,FILTER_SANITIZE_STRING),filter_var($reports_info['id'],FILTER_SANITIZE_STRING));
  			$common_filters->parent_item_id = filter_var($parent_entity_item_id,FILTER_SANITIZE_STRING);
