...
<?php echo form_tag('change_password_form', url_for('items/change_user_password','action=change&path=' . filter_var($_GET['path'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
