...
if(!app_session_is_registered('app_logged_users_id') or CFG_PUBLIC_REGISTRATION_USER_ACTIVATION!='email' or CFG_USE_PUBLIC_REGISTRATION!=1)
{
...
switch($app_module_action)
{
    ...
    case 'update_email':
        ...
        {
            $check_query = db_query("select count(*) as total from app_entity_1 where field_9='" . db_input(filter_var($_POST['email'],FILTER_SANITIZE_STRING)) . "'  and id!='" . db_input(filter_var($app_user['id'],FILTER_SANITIZE_STRING)) . "'");
            ...
            {
                //update account
                db_query("update app_entity_1 set field_9='" . db_input(filter_var($_POST['email'],FILTER_SANITIZE_STRING)) . "' where id='" . db_input(filter_var($app_user['id'],FILTER_SANITIZE_STRING)) . "'");
