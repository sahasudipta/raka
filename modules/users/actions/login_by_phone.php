...
switch($app_module_action)
{
	case 'login':
		...
		$user_query = db_query("select id from app_entity_1 where length(field_" . CFG_2STEP_VERIFICATION_USER_PHONE . ")>0 and rukovoditel_regex_replace('[^0-9]','',field_" . CFG_2STEP_VERIFICATION_USER_PHONE . ") = '" . db_input(preg_replace('/\D/', '', filter_var($_POST['phone'],FILTER_SANITIZE_STRING))) . "'");
