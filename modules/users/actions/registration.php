		...
		case 'save':	
			...
			{	
				...
				while($field = db_fetch_array($fields_query))
				{
					...
					{
						$check_query = db_query("select id from app_fields_choices where fields_id='" . filter_var($field['id'],FILTER_SANITIZE_STRING) . "' and is_default=1");
			...
			case 'attachments_preview':
				...
				{
					$attachments_list[] = filter_var($attachments['filename'],FILTER_SANITIZE_STRING);
					
					if(!in_array($attachments['filename'],$uploadify_attachments_queue[$field_id])) $uploadify_attachments_queue[$field_id][] = filter_var($attachments['filename'],FILTER_SANITIZE_STRING);
