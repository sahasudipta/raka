<?php
  ...
  switch($app_module_action)
  {
    case 'restore':    
        ...
        $user_query = db_query("select * from app_entity_1 where field_12='" . db_input(filter_var($_POST['username'],FILTER_SANITIZE_STRING)) . "' and field_9='" . db_input(filter_var($_POST['email'],FILTER_SANITIZE_STRING)) . "'");
