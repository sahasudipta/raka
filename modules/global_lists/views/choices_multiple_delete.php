...
<?php echo form_tag('form-copy-to', url_for('global_lists/choices','action=multiple_delete&lists_id=' . filter_var($_GET['lists_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
