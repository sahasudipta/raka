...
<?php echo form_tag('choices_import', url_for('global_lists/choices','action=import&lists_id=' . filter_var($_GET['lists_id'])),array('class'=>'form-horizontal','enctype'=>'multipart/form-data')) ?>
