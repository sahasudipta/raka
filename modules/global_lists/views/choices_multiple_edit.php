...
<?php echo form_tag('form-copy-to', url_for('global_lists/choices','action=multiple_edit&lists_id=' . filter_var($_GET['lists_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
...
<div class="modal-body" >
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">	
  	  <?php
  	    $choices = array();
  	    foreach(global_lists::get_choices(filter_var($_GET['lists_id'],FILTER_SANITIZE_STRING)) as $k=>$v)
  	    {  	    	
  	    	if($k=='')
  	    	{
  	    		$choices[-1] = TEXT_NONE;
