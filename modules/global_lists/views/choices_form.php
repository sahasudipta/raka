...
<?php echo form_tag('choices_form', url_for('global_lists/choices','action=save&lists_id=' . filter_var($_GET['lists_id'],FILTER_SANITIZE_STRING) . (isset($_GET['id']) ? '&id=' . filter_var($_GET['id'],FILTER_SANITIZE_STRING):'') ),array('class'=>'form-horizontal')) ?>
...
<div class="tab-content">
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">	
  	  <?php echo select_tag('parent_id',global_lists::get_choices(filter_var($_GET['lists_id'],FILTER_SANITIZE_STRING),true,TEXT_TOP_LEVEL), (isset($_GET['parent_id']) ? filter_var($_GET['parent_id'],FILTER_SANITIZE_STRING) : filter_var($obj['parent_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-control input-large chosen-select')) ?>      
    </div>			
  </div>
