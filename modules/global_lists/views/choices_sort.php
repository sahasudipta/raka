...
<?php echo form_tag('choices_form', url_for('global_lists/choices','action=sort&lists_id=' . filter_var($_GET['lists_id'],FILTER_SANITIZE_STRING)),array('class'=>'form-horizontal')) ?>
<div class="modal-body">
  <div class="form-body">
 
<div class="dd" id="choices_sort">      
<?php echo global_lists::get_choices_html_tree(filter_var($_GET['lists_id'],FILTER_SANITIZE_STRING)) ?>
</div>
