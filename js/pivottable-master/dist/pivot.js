    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        fn = function(c) {
          ...
          btns2 = $("<p>").appendTo(valueList);
          btns2.append($("<button>", {
            type: "button",
            "class":"btn btn-primary"
          }).text(opts.localeStrings.save).bind("click", updateFilter));
          ...
          btns2.append($("<button>", {
            type: "button",
            "class":'btn btn-default'
          }).html(opts.localeStrings.cancel).bind("click", function() {
          	$('.pvtFilterBox').hide()
          }));
          
          triangleLink = $("<span>").addClass('pvtTriangle').html(" <i class=\"fa fa-angle-down\" aria-hidden=\"true\"></i> ").bind("click", showFilterList);
      ...
      if (colorScaleGenerator == null) {
        colorScaleGenerator = function(values) {
          ...
          return function(x) {
            var nonRed;
			var nonGreen;
            nonRed = 255 - Math.round( 190* (1 / x ) );
			nonGreen = 252 - Math.round( 190* (1 / x ) );
